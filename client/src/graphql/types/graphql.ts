...
export type PostFieldsFragment = { __typename?: 'Post', postId: string, userId: string, content: string, createdOn: any, likesCount: number, currentUserLike?: string | null } & { ' $fragmentName'?: 'PostFieldsFragment' };
